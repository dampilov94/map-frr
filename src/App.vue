                    ...
                    <div v-if="Array.isArray(item.coords[0])">
                        ...
                        <l-marker :lat-lng="polygonCenter(item['coords'])" @click="showObjectInfo(item)">
                            <l-icon :icon-size="iconSize" class-name="icon-base">
                                <img :src="getIcon(item['category']['type'])" />
                            </l-icon>
                        </l-marker>
                    </div>
                    <div v-else>
                        <l-marker :lat-lng="item['coords']" @click="showObjectInfo(item)">
                            <l-icon :icon-size="iconSize" class-name="icon-base">
                                <img :src="getIcon(item['category']['type'])" />
                            </l-icon>
                        </l-marker>
        ...
        <div class="panels">
            ...
            <div class="panels__item">
                ...
                >
                    ...
                    <div class="form-row">
                        <div class="col-6">
                            <div class="card-data-block">
                                <div class="card-data-block__title">Площадь (га)</div>
                    ...
                    <div v-b-modal.modal-1 class="object-card__btn">Показать полную информацию</div>
                </div>
            </div>
        </div>
...
export default {
    ...
    computed: {
        ...mapGetters(['allDistricts', 'allLandCategories', 'allTypeOfOwnership', 'allCategoryGroup', 'allObjects']),
